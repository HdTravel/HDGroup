...
class DashboardInit {
	...
	public function __construct(){
		$this->panelItems = array(
									...
									"messages"=>array("title"=>"Messages","url"=>URL::to('#messages'),"icon"=>"fa fa-envelope","permissions"=>array('','teacher','student','parent') ),
									"calender"=>array("title"=>"Calender","url"=>URL::to('#calender'),"icon"=>"fa fa-calendar","permissions"=>array('','teacher','student','parent') ),
									"classSchedule"=>array("title"=>"classSch","url"=>URL::to('#classschedule'),"icon"=>"fa fa-list","permissions"=>array('','teacher','student','parent') ),
									"attendance"=>array("title"=>"Attendance","url"=>URL::to('#attendance'),"icon"=>"fa fa-bar-chart","activated"=>"attendanceAct","permissions"=>array('','teacher'),
														"children"=>array(
									...
									"library"=>array("title"=>"Library","url"=>URL::to('#library'),"icon"=>"fa fa-folder-open","activated"=>"bookslibraryAct","permissions"=>array('','teacher','student','parent') ),
									"media"=>array("title"=>"mediaCenter","url"=>URL::to('#media'),"icon"=>"fa fa-video-camera","activated"=>"mediaAct","permissions"=>array('','teacher','student','parent') ),
									
									"teachers"=>array("title"=>"teachers","url"=>URL::to('#teachers'),"icon"=>"fa fa-suitcase","permissions"=>array('') ),
									"students"=>array("title"=>"students","url"=>URL::to('#students'),"icon"=>"fa fa-users","permissions"=>array('admin','teacher','parent') ),
									"parents"=>array("title"=>"parents","url"=>URL::to('#parents'),"icon"=>"fa fa-user","permissions"=>array('') ),
									
									"gradelevels"=>array("title"=>"gradeLevels","url"=>URL::to('#gradeLevels'),"icon"=>"fa fa-check-square-o","permissions"=>array('') ),
									"assignments"=>array("title"=>"Assignments","url"=>URL::to('#assignments'),"icon"=>"fa fa-file-pdf-o","fa-users","permissions"=>array('admin','teacher','student','parent') ),
									"examslist"=>array("title"=>"examsList","url"=>URL::to('#examsList'),"icon"=>"fa fa-graduation-cap","permissions"=>array('','teacher','student','parent') ),
									"onlineexams"=>array("title"=>"onlineExams","url"=>URL::to('#onlineExams'),"icon"=>"fa fa-graduation-cap","activated"=>"onlineexamsAct","permissions"=>array('','teacher','student') ),
									
									"newsboard"=>array("title"=>"newsboard","url"=>URL::to('#newsboard'),"icon"=>"fa fa-bullhorn","activated"=>"newsboardAct","permissions"=>array('','teacher','student','parent') ),
									"events"=>array("title"=>"events","url"=>URL::to('#events'),"icon"=>"fa fa-clock-o","activated"=>"eventsAct","permissions"=>array('','teacher','student','parent') ),
									...
									"classes"=>array("title"=>"classes","url"=>URL::to('#classes'),"icon"=>"fa fa-sitemap","permissions"=>array('') ),
									"subjects"=>array("title"=>"Subjects","url"=>URL::to('#subjects'),"icon"=>"fa fa-book","permissions"=>array('') ),
									
									"adminTasks"=>array("title"=>"adminTasks","url"=>"","icon"=>"fa fa-cog","permissions"=>array(''),
																				"children"=>array(
																						"promotion"=>array("title"=>"promotion","url"=>URL::to('#promotion'),"icon"=>"fa fa-building-o","permissions"=>array('') ),
																						"mailsms"=>array("title"=>"mailsms","url"=>URL::to('#mailsms'),"icon"=>"fa fa-send","permissions"=>array('') ),	
																						"mailsmsTemplates"=>array("title"=>"mailsmsTemplates","url"=>URL::to('#mailsmsTemplates'),"icon"=>"fa fa-envelope-o","permissions"=>array('') ),	
																						"polls"=>array("title"=>"Polls","url"=>URL::to('#polls'),"icon"=>"fa fa-tasks","activated"=>"pollsAct","permissions"=>array('') ),	
																						"dormitories"=>array("title"=>"Dormitories","url"=>URL::to('#dormitories'),"icon"=>"fa fa-building-o","permissions"=>array('') ),
